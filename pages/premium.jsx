  ...
  const benefits = [
    {
      ...
      description:
        "Access our library of 500+ premium recipes from world-renowned chefs.",
    },
    {
      icon: "📹",
      title: "HD Video Tutorials",
      description:
        "Step-by-step video guides with professional techniques and tips.",
    },
    {
      icon: "📱",
      title: "Meal Planning Tools",
      description:
        "Create and save custom meal plans with automatic grocery lists.",
    },
    {
      icon: "👨‍🍳",
      title: "Chef Q&A Sessions",
      description:
        "Monthly live sessions with professional chefs to answer your questions.",
    },
    {
      icon: "🛒",
      title: "Ingredient Discounts",
      description:
        "Exclusive discounts on specialty ingredients from our partners.",
    },
    {
      icon: "🔄",
      title: "Ad-Free Experience",
      description:
        "Enjoy Recipe Picks without any advertisements or distractions.",
    },
  ];
      ...
      <main className="bg-gray-50">
          ...
          <div className="container mx-auto px-4 py-20 relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-xl mb-8 text-white/90">
                Unlock exclusive recipes, professional techniques, and culinary
                secrets from world-renowned chefs.
              </p>
        ...
        <section id="preview" className="py-16 container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Get a taste of what awaits in our premium collection. These
              gourmet recipes combine exceptional ingredients with expert
              techniques.
            </p>
          </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Our premium membership gives you access to exclusive content and
                features that will transform your cooking experience.
              </p>
            </div>
        ...
        <section id="pricing" className="py-16 container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Choose the plan that's right for you and start exploring our
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="bg-primary p-8 text-white text-center">
                <h3 className="text-2xl font-bold mb-2">
                  Recipe Picks Premium
                </h3>
                <p className="opacity-90 mb-6">
                  All the tools you need to become a better chef
                </p>
              ...
              <div className="p-8">
                <ul className="space-y-4 mb-8">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">
                      HD video tutorials for all premium recipes
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">
                      Monthly live Q&A sessions with chefs
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg
                    ...
                    <span className="text-gray-700">
                      Exclusive discounts on specialty ingredients
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Join thousands of satisfied home chefs who have transformed
                their cooking with Recipe Picks Premium.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-700 mb-4">
                  "The premium recipes have transformed my family dinners. The
                  video tutorials make even complex techniques easy to follow.
                  Worth every penny!"
                </p>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-700 mb-4">
                  "I love the meal planning feature! I'm saving money on
                  groceries and cooking restaurant-quality meals at home. The
                  chef Q&A sessions are incredibly insightful."
                </p>
                <div className="flex items-center">
                  <div className="mr-4 h-12 w-12 rounded-full bg-gray-200 flex items-center justify-center text-gray-700 font-bold">
                    ML
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-700 mb-4">
                  "As a culinary student, the advanced techniques in the premium
                  recipes have helped me develop my skills. The ingredient
                  discounts are a great bonus!"
                </p>
                <div className="flex items-center">
                  <div className="mr-4 h-12 w-12 rounded-full bg-gray-200 flex items-center justify-center text-gray-700 font-bold">
                    TW
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-600">
                    Premium membership gives you instant access to our complete
                    library of premium recipes, HD video tutorials, meal
                    planning tools, and other exclusive features. Once you
                    subscribe, you can access all premium content on any device.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-600">
                    ...
                    billing period. We don't offer refunds for partial
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-600">
                    We add new premium recipes and video tutorials weekly. Our
                    chefs are constantly developing new content to keep your
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-600">
                    Premium recipes are more detailed and feature advanced
                    techniques, specialty ingredients, and comprehensive video
                    tutorials. They're developed by professional chefs and
                    thoroughly tested to ensure perfect results every time.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-primary to-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 text-white/90 max-w-3xl mx-auto">
              Join Recipe Picks Premium today and unlock a world of culinary
              possibilities.
            </p>
