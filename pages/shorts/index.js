...
const shortsData = [
  {
    ...
    description: "Viral string cupcake decorating meets 90's rainbow scratch art! 🌈✨"
  },
  {
    id: 2,
    ...
    description: "The CRISPIEST chicken chips you'll ever try! Secret ingredient: rice flour for extra crunch!"
  },
  {
    id: 3,
    ...
    description: "High-protein, low-carb chicken chips for fitness enthusiasts! Just 3 simple ingredients."
  },
  {
    id: 4,
    ...
    description: "Flamin' Hot Cheetos chicken! The viral recipe that's breaking the internet. So easy to make!"
  },
  {
    id: 5,
    ...
    description: "The ultimate comfort food: loaded fries topped with crispy chicken and melted cheese blend!"
  },
  {
    id: 6,
    ...
    description: "This pasta hack saves so much time! One pot, no draining, and it's ready in just 15 minutes."
  },
  {
    id: 7,
    ...
    description: "Super easy banana bread that doesn't require a mixer! Perfect for overripe bananas."
  },
  {
    id: 8,
    ...
    description: "Make authentic bubble tea at home! Secret to perfect boba pearls revealed."
  },
  {
    id: 9,
    ...
    description: "These avocado fries are crispy on the outside, creamy on the inside! Perfect air fryer recipe."
  },
  {
    id: 10,
    ...
    description: "Quick, healthy dessert that kids love! Frozen yogurt bark with berries and honey."
  },
];
...
export default function ShortsPage() {
  ...
  return (
    <>
      <Head>
        <title>Shorts - Recipe Chef</title>
        <meta name="description" content="Quick recipe videos and cooking tips" />
      </Head>
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3 z-10">
                  <div className="flex items-start gap-2 mb-2">
                    ...
                    <p className="text-white text-sm font-semibold truncate">{short.authorName}</p>
                  </div>
                  <h3 className="text-white text-sm font-medium line-clamp-2 mb-2">{short.title}</h3>
                ...
                <div className={`absolute inset-0 flex items-center justify-center ${hoveredItemId === short.id ? 'opacity-100' : 'opacity-0'} transition-opacity duration-300`}>
            ...
            <div className="h-full w-full relative" ref={shortsContainerRef}>
              ...
              <div className="absolute left-4 top-1/2 transform -translate-y-1/2">
                <button 
                  ...
                  className={`rounded-full bg-black bg-opacity-50 p-2 ${currentShortIndex === 0 ? 'opacity-50' : 'opacity-100'}`}
                >
              ...
              <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                <button 
                  ...
                  className={`rounded-full bg-black bg-opacity-50 p-2 ${currentShortIndex === shortsData.length - 1 ? 'opacity-50' : 'opacity-100'}`}
                >
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
